...
#SBATCH --error=./err_files/ep120-contr05-KLD2.err            # standard error file
#SBATCH --output=./log_files/ep120-contr05-KLD2.log           # standard output file
#SBATCH --account=IscrC_TS-OKD       # account name
#SBATCH --verbose
#SBATCH --cpus-per-task=4

python3 datafree_kd.py --adv 1.33 --bn 10.0 --oh 0.5 --contr 0.5 --new_aug False --contr_loss KLD --temperature 2 --contr_on_stud False \

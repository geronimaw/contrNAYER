...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        vis_results, cost, loss_synthesizer, loss_oh, loss_contr, loss_adv, loss_bn = synthesizer.synthesize()  # g_steps
        ...
        wandb.log({"Acc1": acc1, "Acc5": acc5, "VLoss": val_loss, "lr": optimizer.param_groups[0]['lr'],
                   "SLoss": loss_synthesizer, "OHLoss": loss_oh, "CLoss": loss_contr, "ADVLoss": loss_adv, "BNLoss":loss_bn})
